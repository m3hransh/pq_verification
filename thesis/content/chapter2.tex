...
To support updates without mutation, functional data structures rely on \textbf{persistence}: operations return a new version of the structure while preserving the old one.
