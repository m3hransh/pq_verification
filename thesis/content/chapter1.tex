...
\texttt{LiquidHaskell} offers an alternative: a lightweight refinement type
...
% TODO: This should be change if I add other implementation
The key contributions are as follows.
First, we implement two different priority queue variants, \emph{Leftist Heaps} and \emph{Binomial Heaps}, in Haskell.
...
\begin{itemize}
	\item \textbf{Chapter 2} provides background on functional data structures,
	      ...
	      related work.
	\item \textbf{Chapter 3} describes the design and implementation of \emph{Leftist Heaps} and \emph{Binomial Heaps} in Haskell.
	...
	\item \textbf{Chapter 6} concludes the thesis by summarizing the findings,
	        discussing limitations, and suggesting directions for future work.
