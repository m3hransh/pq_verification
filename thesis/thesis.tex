...
\lstdefinelanguage{Haskell}{
  ...
  morekeywords=[2]{measure,invariant,reflect,assume,assert,termination,ple,qualif,axiomatize, EmptyView, EmptyHeap, HeapNode, Min, Nil, Cons},
% Function names you want emphasized:
  morekeywords=[3]{insert,deleteMin,merge,put, bag,findMin, rank, lookup, empty, isEmpty, 
    ...
    rrank, min, bogusUnion, lemma_isLowerBound_transitive, lemma_merge_case1, heapMerged, 
    lemma_heapMerge_case2, heapInsert, heapDeleteMin, heapSplit, safeHeapFindMin},
  % Typeclasses or types you want emphasized:
  morekeywords=[4]{Ord,Eq,Show,Functor,Monad,PriorityQueue, LeftistHeap, Nat, Pos, Int, Btwn, Bool, Bag, PList},
