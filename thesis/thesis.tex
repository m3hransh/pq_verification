...
% Function names you want emphasized:
  morekeywords=[3]{insert,deleteMin,merge,put, bag,findMin, rank, lookup, empty, isEmpty, splitMin, value, left, right, heapMerge, makeHeapNode, divide, bad, div, isLowerBound, HeapMergeMin, heapIsEmpty, BagUnion, heapFindMin, phd, ptl, withProof, assoc},
