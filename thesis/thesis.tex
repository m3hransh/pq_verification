...
% Function names you want emphasized:
  morekeywords=[3]{insert,deleteMin,merge,findMin,rank, empty, isEmpty, splitMin},
  % Typeclasses or types you want emphasized:
  morekeywords=[4]{Ord,Eq,Show,Functor,Monad,PriorityQueue},
...
\lstnewenvironment{code}{\lstset{style=codeModern}}{}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
