...
% Function names you want emphasized:
  morekeywords=[3]{insert,deleteMin,merge,findMin,rank, lookup, empty, isEmpty, splitMin, value, left, right, heapMerge, makeHeapNode, divide, bad, div},
  % Typeclasses or types you want emphasized:
  morekeywords=[4]{Ord,Eq,Show,Functor,Monad,PriorityQueue, LeftistHeap, Nat, Pos, Int, Btwn},
