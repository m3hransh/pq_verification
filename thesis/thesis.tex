...
% Function names you want emphasized:
  morekeywords=[3]{insert,deleteMin,merge,findMin,rank, empty, isEmpty, splitMin, value, left, right, heapMerge, makeHeapNode},
  % Typeclasses or types you want emphasized:
  morekeywords=[4]{Ord,Eq,Show,Functor,Monad,PriorityQueue, LeftistHeap},
