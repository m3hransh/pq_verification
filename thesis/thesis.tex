...
\lstdefinelanguage{Haskell}{
  ...
  morekeywords=[2]{measure,invariant,reflect,assume,assert,termination,ple,qualif,axiomatize, EmptyView, EmptyHeap, HeapNode, Min},
% Function names you want emphasized:
  morekeywords=[3]{insert,deleteMin,merge,findMin,rank, lookup, empty, isEmpty, splitMin, value, left, right, heapMerge, makeHeapNode, divide, bad, div, isLowerBound, HeapMergeMin, heapIsEmpty, BagUnion, heapFindMin},
